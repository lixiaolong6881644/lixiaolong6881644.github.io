    ...
    xkTool.extend({
        ...
        setBanner: function (img, filter) {
            if (!filter) {
                ...
                $(".full_page").css({
                    backgroundImage: 'url("https://ae01.alicdn.com/kf/H18a4b998752a4ae68b8e85d432a5aef0l.png"), linear-gradient(60deg, rgba(255, 165, 150, 0.5) 5%, rgba(0, 228, 255, 0.35)), url(' + img + ")",
                })
            }
        },
    });
    ...
    xkTool.prototype.extend({
        ...
        cheatTitle: function (leaveTitle, backTitle, leaveIcon, backIcon) {
            ...
            document.addEventListener("visibilitychange", function () {
                if (document.hidden) {
                    $('[rel="icon"]').attr("href", leaveIcon ? leaveIcon : "https://cdn.jsdelivr.net/gh/sviptzk/StaticFile_HEXO@v3.2.7.1/butterfly/img/favicon.ico");
                    document.title = leaveTitle ? leaveTitle : "！！这里这里 ◕ ں ◕ ";
                    clearTimeout(titleTime)
                } else {
                    $('[rel="icon"]').attr("href", backIcon ? backIcon : "https://cdn.jsdelivr.net/gh/sviptzk/StaticFile_HEXO@v3.2.7.1/butterfly/img/favicon.ico");
                    document.title = backTitle ? backTitle : "(ฅ>ω<*ฅ) 欢迎回来哦！爱你哟~" + OriginTitle;
        ...
        footFish: function () {
            ...
            $("body").append('<script src="https://cdn.jsdelivr.net/gh/sviptzk/StaticFile_HEXO@master/lib/js/fish.js"></script>');
            return this
        },
        aplayer: function (obj) {
            ...
            $.getScript("https://cdn.jsdelivr.net/gh/sviptzk/HexoStaticFile@v0.1/Hexo/assets/js/APlayer.min.js", function () {
        ...
        meting: function (id, server, type) {
            $("head").append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/sviptzk/HexoStaticFile@v0.1/Hexo/assets/css/APlayer.min.css" class="aplayer-style-marker">');
            let APlayerJs = $.getScript("https://cdn.jsdelivr.net/gh/sviptzk/HexoStaticFile@v0.1/Hexo/assets/js/APlayer.min.js");
            let MetingJS = $.getScript("https://cdn.jsdelivr.net/npm/meting@2.0.1/dist/Meting.min.js");
            let pAll = Promise.all([APlayerJs, MetingJS]);
            pAll.then(() => {
                $("body").append(`<meting-js id=${id}server=${server}type=${type}fixed="true"mini="true"></meting-js>`)
            }
            )
        },
    });
